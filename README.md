...
The implementation uses generalized suffix arrays, LCP arrays, common unique maximal exact matches, maximum-weight anchor chaining, and recursive gap refinement.
